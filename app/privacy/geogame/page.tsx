        ...
        <div className="bg-white dark:bg-gray-900 rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100 dark:border-gray-800">
          ...
          <div className="space-y-8 text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            <div>
              ...
              <p>
                Gizlilik Politikam ile ilgili herhangi bir sorunuz veya öneriniz varsa, benimle iletişime geçmekten çekinmeyin. Bana <a href="mailto:iletisim@keremkk.com.tr" className="text-blue-600 dark:text-blue-400 hover:underline">iletisim@keremkk.com.tr</a> adresinden ulaşabilirsiniz.
              </p>
            </div>
          </div>
        </div>
