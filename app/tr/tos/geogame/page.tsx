...
export default function GeoGameTermsOfServiceTR() {
  return (
        ...
        <div className="bg-white dark:bg-gray-900 rounded-3xl p-8 md:p-12 shadow-sm border border-gray-100 dark:border-gray-800">
          ...
          <div className="space-y-8 text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            <div>
              ...
              <p>
                Hesabınızı ve tüm ilişkili verilerinizi kalıcı olarak silmek istemeniz durumunda, <a href="mailto:help@keremkk.com.tr" className="text-blue-600 dark:text-blue-400 hover:underline">help@keremkk.com.tr</a> adresine başvurabilir veya <a href="/tr/delete-account" className="text-blue-600 dark:text-blue-400 hover:underline">Hesap Silme</a> sayfamızı ziyaret edebilirsiniz. Hesap silme talepleriniz en geç 30 gün içinde işleme alınacaktır. Silinen hesaplar ve veriler geri alınamaz.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                <a href="/tr/privacy/geogame" className="text-blue-600 dark:text-blue-400 hover:underline">
